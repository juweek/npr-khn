      ...
      svg
        ...
        .attr("fill", (d) => {
          ...
          if (parseInt(medicalDebt[0]) > 1000) {
            return "#D64833";
          } else if (parseInt(medicalDebt[0]) > 500) {
            return "#E18D39";
          } else {
            return "#EBE2AA";
          }
          ...
          tooltip
            .html('<b>' +
              d.target.__data__.properties.name +
                ...
                "mn<br><b>How many settlements are they a part of?</b>" +
                ": " + percentCollectionsAmt.toFixed(0) )
            .style("left", function () {
...
*/
  d3.json(
    ...
    .then(function (us) {
      ...
      let radius = d3.scaleSqrt([50, 2000], [12, 45]);
