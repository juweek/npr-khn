...
export const tooltipHandlers = {
    ...
    mouseEnter: function (xLocation, yLocation, currentElement, originalDataCMS) {
        ...
        let currentSettlement = currentElement.getAttribute('data-reportedPublicly')
        ...
        tooltip
            ...
            .html(
                `<div class="tooltip__hospital"><b>${currentStateName}</b></div><div class="tooltip__name"><b>Publicly reported funds: </b>${currentSettlement}%</div>`
            );
    },
